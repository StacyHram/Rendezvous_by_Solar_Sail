% get atmospheric density for the specified altitude
...
intervalNumber = sum(altitude/km2m <= baseAltitudes, 2) + 1;
...
rhoAtmo = nominalDensity * exp((baseAltitude - altitude / km2m ) / scaleAltitude);
end
