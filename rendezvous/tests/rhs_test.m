function derivativeCoMCoordinates = rhs_test(t, rv, simulationSettings, initialConditions, spacecraft)
...
% Calculates right side of ODE for motion of single point (center of mass) motion
  ...
  %% Sun pressure
  [pressSun, ~] = sunPressure_test(rECI, vECI, sunECI, simulationSettings.sunPressureModel, spacecraft);
